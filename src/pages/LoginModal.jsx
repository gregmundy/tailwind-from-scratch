import image from '../assets/login-modal/image.jpg';
    ...
    <div className="flex items-center justify-center min-h-screen bg-rose-50">
      <div className="relative flex flex-col m-6 space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0">
        ...
        <div className="p-6 md:p-20">
          ...
          <input type="text" className="w-full p-6 border border-gray-300 rounded-md placeholder:font-sans placeholder:font-light" placeholder='Enter your email address'/>
          {/* Middle Content */}
          ...
          <div className="flex flex-col space-x-0 space-y-6 md:flex-row md:space-x-4 md:space-y-0">
            <button className='flex items-center justify-center py-2 space-x-3 border border-gray-300 rounded shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition duration-150 md:w-1/2' >
              <img src={facebook} alt="facebook social link" className='w-9' />
              <span className='font-thin'>Facebook</span>
            </button>
            <button className='flex items-center justify-center py-2 space-x-3 border border-gray-300 rounded shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition duration-150 md:w-1/2' >
              <img src={google} alt="facebook social link" className='w-9' />
        ...
        {/* Right side */}
        <img src={image} alt="background" className='w-[430px] hidden md:block' />
        {/* Close Button */}
